...
forumRouter.delete("/:articleNum", (req, res, next) => loginController.isLoggedIn(req, res, next), async (req, res) => forumController.deleteArticle(req,res));
...
//deletes a comment
forumRouter.delete("/:articleNum/:commentNum", (req, res, next) => loginController.isLoggedIn(req, res, next), async (req, res) => forumController.deleteComment(req,res));

//edits a comment
forumRouter.post("/editOld", (req, res, next) => loginController.isLoggedIn(req, res, next), async (req, res) => forumController.changeComment(req,res));
