<template>
  <div class="login">
    ...
    <div class="login-form">
      <div class="form-item">
        <input maxlength="15" v-model.trim="forms.nickname" placeholder="Please enter a nickname">
      </div>
      <div class="form-item">
        <input maxlength="15" v-model.trim="forms.userName" placeholder="Please enter your account number">
      </div>
      <div class="form-item">
        <input maxlength="15" v-model.trim="forms.password" placeholder="Please input a password" type="password">
      </div>
      <div class="form-item">
