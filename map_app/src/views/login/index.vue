<template>
  <div class="login">
    ...
    <div class="login-form">
      <div class="form-item">
        <input v-model.trim="forms.userName" placeholder="Please enter your account number">
      </div>
      <div class="form-item">
        <input v-model.trim="forms.password" placeholder="Please input a password" type="password">
      </div>
      <div class="form-item">
