<template>
  <div class="map-wrap">
    ...
    <div class="map-content">
      <div class="form-item" style="height:auto;margin-bottom:15px;text-align:center">
        <van-uploader v-model="fileList" :max-count="1" :after-read="afterRead" />
      </div>
      <div class="form-item">
        <input v-model.trim="forms.nickname" placeholder="Please enter your nickname" maxlength="20">
      </div>
      <div class="form-item">
