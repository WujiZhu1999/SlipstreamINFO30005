			...
			var a = function () {
					...
					return n('div', { staticClass: 'map-wrap' }, [
						...
						n(
							...
							[
								'Follow' === t.$route.query.type
									? t._l(t.followList, function (e) {
											return n('Item', {
												key: e._id,
												attrs: { data: e.friend, status: e.status },
												on: {
									...
									: t._l(t.fansList, function (e) {
											return n('Item', {
												key: e._id,
												attrs: { data: e.me, status: e.status },
												on: {
													updateList: function (e) {
														return t.getList();
													},
				...
				c =
					(n('c5f6'),
					{
						props: { data: Object, status: Number },
						methods: {
				...
				u = c,
				l = (n('1e75'), n('2877')),
				d = Object(l['a'])(u, i, o, !1, null, 'f4baf7dc', null),
				f = d.exports,
				h = {
					components: { Item: f },
					data: function () {
													...
													case 0:
														return (
															...
															this.$http({
																...
																method: 'post',
																data: { me: this.$store.getters.user._id },
															})
														);
													case 2:
														(e = t.sent),
															(n = e.data),
															(this.followTotal = n.followTotal),
															(this.fansTotal = n.fansTotal),
															(this.followList = n.followList),
															(this.fansList = n.fansList);
													case 8:
													case 'end':
														return t.stop();
												}
				...
				p = h,
				m = (n('8b99'), Object(l['a'])(p, a, s, !1, null, '7dbc7c86', null));
			e['default'] = m.exports;
		},
		'8b99': function (t, e, n) {
			'use strict';
